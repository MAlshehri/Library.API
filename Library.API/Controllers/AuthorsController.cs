...
namespace Library.API.Controllers
{
    ...
    public class AuthorsController : Controller
    {
        ...
        {
            var authors = await _libraryRepository.GetAuthors();
        ...
        {
            var author = await _libraryRepository.GetAuthor(id);
            if (author == null)
                return NotFound();
        ...
        public IActionResult AddAuthors()
        {
            ...
            authors.ForEach(x => _libraryRepository.AddAuthor(x));
            var u = _libraryRepository.Save();
